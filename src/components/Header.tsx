    ...
    <header className="mb-4 flex min-w-0 flex-col gap-3 sm:mb-6 xl:flex-row xl:items-start xl:justify-between">
      ...
      <div className="flex w-full min-w-0 flex-col items-stretch gap-3 pt-1 xl:w-auto xl:items-end">
        ...
        <div className="flex w-full min-w-0 flex-wrap items-center gap-2 sm:gap-3 xl:w-auto">
          {showRangeControls ? (
            <div className="flex min-w-0 flex-1 basis-full flex-wrap items-center gap-2 rounded-[14px] border border-[#d4e1f2] bg-white px-3 py-2.5 shadow-[0_10px_24px_rgba(30,86,180,0.12)] dark:border-white/[0.08] dark:bg-white/[0.04] sm:basis-auto sm:px-4 sm:py-3">
          ...
          {showRangeControls ? (
            <button
              type="button"
              onClick={applyToday}
              className="min-h-11 flex-1 rounded-[14px] border border-[#d4e1f2] bg-white px-5 py-2.5 text-sm font-black text-[#273c63] shadow-[0_10px_24px_rgba(30,86,180,0.12)] transition hover:bg-blue-50 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-slate-200 dark:hover:bg-white/[0.08] sm:flex-none sm:px-6 sm:py-3"
            >
              오늘
            </button>
          ) : null}
